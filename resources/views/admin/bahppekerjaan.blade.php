  ...
  <div class="content-wrapper">
     ...
     <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">BAHP Pekerjaan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item">Tabel Penilaian</li>
              <li class="breadcrumb-item active">BAHP Pekerjaan</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<!-- /.content-header -->
  @include('../admin.form_bahppekerjaan')
    <!-- /.content -->
  </div>
  <!-- /.content-wrapper -->
...
<script>
  ...
  text: "File yang telah diupload tidak dapat diedit kembali!",
  icon: 'warning',
